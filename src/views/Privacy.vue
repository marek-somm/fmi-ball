<template>
	<div id="privacy" ref="wrapper">
		...
		<p>
			...
			<a
				class="link"
				href="https://www.bfdi.bund.de/DE/Service/Kontakt/kontakt_node.html"
				target="_blank"
				>Aufsichtsbehörden</a
			>
		...
		<p>
			...
			entsprechende Einwilligung vorliegt. Danach werden sie gelöscht. Die
			Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein
			auf Basis Ihrer Einwilligung. Ohne bestehende Einwilligung können wir
			Ihnen unseren Newsletter leider nicht zusenden. Die Einwilligung zur
			...
			Link oder beim unten aufgeführten Datenschutzbeauftragten bzw. der für
			den Datenschutz zuständigen Person beantragt werden.
		</p>
